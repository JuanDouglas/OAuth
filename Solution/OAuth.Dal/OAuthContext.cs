...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Account>(entity =>
            {
                ...
                entity.HasIndex(e => e.Email, "UQ__Account__A9D1053458BD4384")
                    .IsUnique();

                entity.HasIndex(e => e.Key, "UQ__Account__C41E0289BD92EDD0")
                    .IsUnique();

                entity.HasIndex(e => e.UserName, "UQ__Account__C9F284569CBD5608")
                    .IsUnique();
            ...
            modelBuilder.Entity<Application>(entity =>
            {
                ...
                entity.HasIndex(e => e.Key, "UQ__Applicat__C41E02894360C6C7")
                    .IsUnique();
            ...
            modelBuilder.Entity<ApplicationAuthentication>(entity =>
            {
                ...
                entity.HasIndex(e => e.Token, "UQ__Applicat__1EB4F8172381AA63")
                    .IsUnique();
            ...
            modelBuilder.Entity<Authentication>(entity =>
            {
                ...
                entity.HasIndex(e => e.Token, "UQ__Authenti__1EB4F81767239CE0")
                    .IsUnique();
            ...
            modelBuilder.Entity<Company>(entity =>
            {
                ...
                entity.HasIndex(e => e.Cnpj, "UQ__Company__AA57D6B4125D8863")
                    .IsUnique();

                entity.HasIndex(e => e.Account, "UQ__Company__B0C3AC464BDDAA8F")
                    .IsUnique();
            ...
            modelBuilder.Entity<Ip>(entity =>
            {
                ...
                entity.HasIndex(e => e.Adress, "UQ__IP__08F62FE53B42F84B")
                    .IsUnique();
            ...
            modelBuilder.Entity<Personal>(entity =>
            {
                ...
                entity.HasIndex(e => e.Account, "UQ__Personal__B0C3AC46067D9134")
                    .IsUnique();
